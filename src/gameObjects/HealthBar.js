class HealthBar {
    constructor(scene, x, y, max = 100, current = 100) {
        ...
        let height_diff = this.bar_full.displayHeight- this.maskbar.displayHeight;
    ...
    update(current) {
        ...
        this.maskbar.y = this.startY + this.maskbar.displayHeight - (this.current / this.max * this.maskbar.displayHeight);
    }
